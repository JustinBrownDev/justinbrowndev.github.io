...
assert.match(runner, /runLegacyApplicatorAudit/);
assert.match(runner, /LEGACY APPLICATOR AUDIT PASS/);
assert.match(runner, /jweb\.pushzip-runner\.v5/);
assert.match(runner, /legacy schema requires applicatorAudit=true/);
