...
for (const needle of [
  ...
  'semanticSpaceIdForEntity(aEntity, bridge.aModuleKey, aSemanticFloor',
  'semanticSpaceIdForEntity(bEntity, bridge.bModuleKey, bSemanticFloor',
  'entity?.buildingPlan?.topologySpaces',
  'aEndpoint?.globalFloor',
  'bEndpoint?.globalFloor',
  'aEndpoint?.id ?? null',
  'bEndpoint?.id ?? null',
  'entity?.cityTransferAuthority?.bindings',
